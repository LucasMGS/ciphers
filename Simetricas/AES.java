...
public class AES {
    ...
    public static void Run(){
        ...
        String key = "1ewrw23erwe112se";
        File inputFile = new File(_currentDir + "/arquivos/simetricas/AES/inputFile.txt");
        File encryptedFile = new File(_currentDir + "/arquivos/simetricas/AES/Encrypted.txt");
        File decryptedFile = new File(_currentDir + "/arquivos/simetricas/AES/Decrypted.txt");
